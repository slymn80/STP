...
- Use key vocabulary in short explanations about Practical work.
...
- Gives at least two real-life examples related to Practical work.
...
- Teacher: Define Practical work with a simple example.
- Students: Share one place they see information today.

## Main Content (30 minutes)
- Explain the idea: Practical work can be presented in different forms that keep the same meaning.
...
- Oral Q&A: Students define Practical work and name two forms with examples.
