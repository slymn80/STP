...
- Use key vocabulary in short explanations about Digital media.
...
- Gives at least two real-life examples related to Digital media.
...
- Teacher: Define Digital media with a simple example.
- Students: Share one place they see information today.

## Main Content (30 minutes)
- Explain the idea: Digital media can be presented in different forms that keep the same meaning.
...
- Oral Q&A: Students define Digital media and name two forms with examples.
