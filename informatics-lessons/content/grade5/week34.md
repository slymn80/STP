...
- Use key vocabulary in short explanations about Implementation of mini-projects.
...
- Gives at least two real-life examples related to Implementation of mini-projects.
...
- Teacher: Define Implementation of mini-projects with a simple example.
- Students: Share one place they see information today.

## Main Content (30 minutes)
- Explain the idea: Implementation of mini-projects can be presented in different forms that keep the same meaning.
...
- Oral Q&A: Students define Implementation of mini-projects and name two forms with examples.
