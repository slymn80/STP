...
- Use key vocabulary in short explanations about Working with curves.
...
- Gives at least two real-life examples related to Working with curves.
...
- Teacher: Define Working with curves with a simple example.
- Students: Share one place they see information today.

## Main Content (30 minutes)
- Explain the idea: Working with curves can be presented in different forms that keep the same meaning.
...
- Oral Q&A: Students define Working with curves and name two forms with examples.
