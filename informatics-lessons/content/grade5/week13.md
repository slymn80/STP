...
## Learning Objectives
- Explain Creating vector images in clear, age-appropriate language.
- Identify the key parts or steps of Creating vector images.
- Apply Creating vector images to a real-life or classroom example.
- Demonstrate: Create and edit vector images.
- Use Creating vector images vocabulary accurately in short explanations.

## Assessment Criteria
- Uses correct terminology when explaining Creating vector images.
...
## Key Vocabulary
- creating: a key term related to Creating vector images
- vector: a key term related to Creating vector images
- images: a key term related to Creating vector images
- create: a key term related to Creating vector images
- edit: a key term related to Creating vector images
- vector: a key term related to Creating vector images
...
## Introduction (5 minutes)
- Introduce Creating vector images and link it to everyday technology.
- Warm-up questions:
- - Where do we encounter this idea in daily life?
- - How does this help computers work correctly?
- Real-life examples:
- - A classroom example connected to Creating vector images.
...
- Oral Q&A: Students explain one part of Creating vector images.
- Quick written check: 3 short questions.
- Mini rubric: 3 = accurate and complete, 2 = mostly correct, 1 = needs support

## Homework
- Write a short paragraph about Creating vector images using at least 4 vocabulary terms.

## Teacher Reflection
- Which part of Creating vector images was easiest for students to understand?
