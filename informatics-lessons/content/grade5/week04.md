...
- Use key vocabulary in short explanations about Information encryption.
...
- Gives at least two real-life examples related to Information encryption.
...
- Teacher: Define Information encryption with a simple example.
- Students: Share one place they see information today.

## Main Content (30 minutes)
- Explain the idea: Information encryption can be presented in different forms that keep the same meaning.
...
- Oral Q&A: Students define Information encryption and name two forms with examples.
