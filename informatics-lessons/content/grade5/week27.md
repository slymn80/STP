...
- Use key vocabulary in short explanations about Computer and Security, How not to hurt yourself when working at a computer.
...
- Gives at least two real-life examples related to Computer and Security, How not to hurt yourself when working at a computer.
...
- Teacher: Define Computer and Security, How not to hurt yourself when working at a computer with a simple example.
- Students: Share one place they see information today.

## Main Content (30 minutes)
- Explain the idea: Computer and Security, How not to hurt yourself when working at a computer can be presented in different forms that keep the same meaning.
...
- Oral Q&A: Students define Computer and Security, How not to hurt yourself when working at a computer and name two forms with examples.
