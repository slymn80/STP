...
- Shows understanding of: Functions in Python, Predefined Functions.

## Key Vocabulary
- programming: a key term related to Programming
- functions: a key term related to Programming
- python: a key term related to Programming
- predefined: a key term related to Programming
- functions: a key term related to Programming
...
- - Link to: Functions in Python, Predefined Functions.
...
- Focus point: Functions in Python.
- Focus point: Predefined Functions.
