...
duration: "40 minutes"
---
# Grade 10 - Week 17: Software
## Learning Objectives
- Explain Software in clear, age-appropriate language.
- Identify the key parts or steps of Software.
- Apply Software to a real-life or classroom example.
- Demonstrate: Introduction to Mysql.
- Demonstrate: Let's Create Our First Database Using SQL.

## Assessment Criteria
- Uses correct terminology when explaining Software.
- Completes the practice activity accurately.
- Responds to oral questions with clear reasoning.
- Shows understanding of: Introduction to Mysql, Let's Create Our First Database Using.

## Key Vocabulary
- software: a key term related to Software
- introduction: a key term related to Software
- mysql: a key term related to Software
- let: a key term related to Software
- s: a key term related to Software
- create: a key term related to Software
...
## Introduction (5 minutes)
- Introduce Software and link it to everyday technology.
- Warm-up questions:
- - Where do we encounter this idea in daily life?
- - How does this help computers work correctly?
- Real-life examples:
- - A classroom example connected to Software.
- - Link to: Introduction to Mysql, Let's Create Our First Database Using SQL.
...
- Focus point: Introduction to Mysql.
- Focus point: Let's Create Our First Database Using SQL.
...
![Lesson Visual](/content/images/grade10/week17.png)
...
- Apply: Introduction to Mysql.
- Apply: Let's Create Our First Database Using SQL.

## Assessment
- Observation during activity.
- Oral Q&A: Students explain one part of Software.
- Quick written check: 3 short questions.
- Mini rubric: 3 = accurate and complete, 2 = mostly correct, 1 = needs support

## Homework
- Write a short paragraph about Software using at least 4 vocabulary terms.
