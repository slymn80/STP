...
- Demonstrate: Operations with Select Statement.
...
- Shows understanding of: Operations with Select Statement.

## Key Vocabulary
- software: a key term related to Software
- operations: a key term related to Software
- select: a key term related to Software
- statement: a key term related to Software
...
- - Link to: Operations with Select Statement.
...
- Focus point: Operations with Select Statement.
...
- Apply: Operations with Select Statement.
