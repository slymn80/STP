...
- Demonstrate: Overview of Database Fields.
- Demonstrate: Keys in Database.
...
- Shows understanding of: Overview of Database Fields, Keys in Database.

## Key Vocabulary
- software: a key term related to Software
- overview: a key term related to Software
- database: a key term related to Software
- fields: a key term related to Software
- keys: a key term related to Software
- database: a key term related to Software
...
- - Link to: Overview of Database Fields, Keys in Database.
...
- Focus point: Overview of Database Fields.
- Focus point: Keys in Database.
- Discuss a practical application or case study.
- Teacher: Model the process step-by-step and check for understanding.
- Students: Take brief notes and answer a quick concept check.

![Lesson Visual](../images/grade10/week16.png)
