...
- Use key vocabulary in short explanations about Comparison of raster and vector images.
...
- Gives at least two real-life examples related to Comparison of raster and vector images.
...
- Teacher: Define Comparison of raster and vector images with a simple example.
- Students: Share one place they see information today.

## Main Content (30 minutes)
- Explain the idea: Comparison of raster and vector images can be presented in different forms that keep the same meaning.
...
- Oral Q&A: Students define Comparison of raster and vector images and name two forms with examples.
