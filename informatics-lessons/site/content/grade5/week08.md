...
- Use key vocabulary in short explanations about Practical tasks.
...
- Gives at least two real-life examples related to Practical tasks.
...
- Teacher: Define Practical tasks with a simple example.
- Students: Share one place they see information today.

## Main Content (30 minutes)
- Explain the idea: Practical tasks can be presented in different forms that keep the same meaning.
...
- Oral Q&A: Students define Practical tasks and name two forms with examples.
