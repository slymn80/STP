...
- Use key vocabulary in short explanations about The movement of the robot along the line. Practical work.
...
- Gives at least two real-life examples related to The movement of the robot along the line. Practical work.
...
- Teacher: Define The movement of the robot along the line. Practical work with a simple example.
- Students: Share one place they see information today.

## Main Content (30 minutes)
- Explain the idea: The movement of the robot along the line. Practical work can be presented in different forms that keep the same meaning.
...
- Oral Q&A: Students define The movement of the robot along the line. Practical work and name two forms with examples.
