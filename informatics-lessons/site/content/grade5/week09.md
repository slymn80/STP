...
- Use key vocabulary in short explanations about Computer graphics, Raster and vector graphic editors.
...
- Gives at least two real-life examples related to Computer graphics, Raster and vector graphic editors.
...
- Teacher: Define Computer graphics, Raster and vector graphic editors with a simple example.
- Students: Share one place they see information today.

## Main Content (30 minutes)
- Explain the idea: Computer graphics, Raster and vector graphic editors can be presented in different forms that keep the same meaning.
...
- Oral Q&A: Students define Computer graphics, Raster and vector graphic editors and name two forms with examples.
