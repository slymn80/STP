...
- Use key vocabulary in short explanations about Creating vector images.
...
- Gives at least two real-life examples related to Creating vector images.
...
- Teacher: Define Creating vector images with a simple example.
- Students: Share one place they see information today.

## Main Content (30 minutes)
- Explain the idea: Creating vector images can be presented in different forms that keep the same meaning.
...
- Oral Q&A: Students define Creating vector images and name two forms with examples.
