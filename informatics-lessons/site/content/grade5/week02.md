...
- Use key vocabulary in short explanations about Transmitting information.
...
- Gives at least two real-life examples related to Transmitting information.
...
- Teacher: Define Transmitting information with a simple example.
- Students: Share one place they see information today.

## Main Content (30 minutes)
- Explain the idea: Transmitting information can be presented in different forms that keep the same meaning.
...
- Oral Q&A: Students define Transmitting information and name two forms with examples.
