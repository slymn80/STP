...
date: "2026-05-05"
day: "Tuesday"
topic: "Creating shared folders and files"
duration: "45 minutes"
---
...
- Use key vocabulary in short explanations about Creating shared folders and files.
...
- Gives at least two real-life examples related to Creating shared folders and files.
...
![Lesson visual](/content/images/grade5/week32.png)
...
- Teacher: Define Creating shared folders and files with a simple example.
- Students: Share one place they see information today.

## Main Content (30 minutes)
- Explain the idea: Creating shared folders and files can be presented in different forms that keep the same meaning.
...
- Oral Q&A: Students define Creating shared folders and files and name two forms with examples.
