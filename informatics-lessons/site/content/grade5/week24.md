...
- Use key vocabulary in short explanations about Robo-sumo.
...
- Gives at least two real-life examples related to Robo-sumo.
...
- Teacher: Define Robo-sumo with a simple example.
- Students: Share one place they see information today.

## Main Content (30 minutes)
- Explain the idea: Robo-sumo can be presented in different forms that keep the same meaning.
...
- Oral Q&A: Students define Robo-sumo and name two forms with examples.
