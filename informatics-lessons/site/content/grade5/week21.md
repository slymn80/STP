...
- Use key vocabulary in short explanations about Robot turns. Practical work.
...
- Gives at least two real-life examples related to Robot turns. Practical work.
...
- Teacher: Define Robot turns. Practical work with a simple example.
- Students: Share one place they see information today.

## Main Content (30 minutes)
- Explain the idea: Robot turns. Practical work can be presented in different forms that keep the same meaning.
...
- Oral Q&A: Students define Robot turns. Practical work and name two forms with examples.
